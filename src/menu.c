	...
	//Fallthrough
		...
		case MenuPage_Story:
		{
			static const struct
			{
				...
				{"1", StageId_1_1, "VS TAILS EXE", {"CHASING", "DARKNESS", "SIDEKICK"}},
				{NULL, StageId_1_4, "SKYWAY OCTANE", {"OCTANE", NULL, NULL}},
			};
		...
		case MenuPage_Freeplay:
		{
			static const struct
			{
				...
				{StageId_1_1, 0xFF9271FD, "CHASING"},
				{StageId_1_2, 0xFF9271FD, "DARKNESS"},
				{StageId_1_3, 0xFF9271FD, "SIDEKICK"},
				{StageId_1_4, 0xFF9271FD, "OCTANE"},
			};
